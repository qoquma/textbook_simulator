...
class TextbookPage extends React.Component{
    ...
    render() {
        let count_for_key = 0;
        const { textbook_summary, textbook_title,textbook_subtitle, step_description_items,toast_step_items, append_description, remove_description, append_step, remove_step } = this.props;
